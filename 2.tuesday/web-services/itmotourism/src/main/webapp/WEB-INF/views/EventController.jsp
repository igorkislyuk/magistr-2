    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <form action="/createEvent" method="POST" data-form-title="Autentification">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="info" required="" rows=3 placeholder="Информация"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="kindOfSport" id="kindOfSport" onblur="check()">
                    ...
                    <div class="mbr-buttons mbr-buttons--right"><button type="submit" class="mbr-buttons__btn btn btn-lg btn-danger">Добавить</button></div>
                </form>
                <form action="/eventData" method="POST" data-form-title="Получить данные о событии">
                    <select name="eventName" id="eventName">
                        ...
                        <%CompetitionsRepository competitionsRepository = (CompetitionsRepository)session.getAttribute("events");
                            List<Competitions> iter = competitionsRepository.findAll();
                            for (Competitions competitions: iter) {%>
                        <option>
                            <%=competitions.getName()+"("+competitions.getDate()+")"%>
                        </option><%}
                        session.removeAttribute("events");
                    %></select>
                    <div class="mbr-buttons mbr-buttons--right"><button type="button" class="btn btn-md btn-primary display-4" onclick="getEventData()">Данные о событии</button></div>
